...
class _CardScreenState extends State<CardScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    String descricao = "Um vestido vermelho e bonito para ocasiões simples e bem barato para quem quer ficar estiloso sem gastar muito";
    String image =
                          ...
                          Align(
                            ...
                            child: Container(
                              ...
                              child: AutoSizeText(
                                ...
                                maxLines: 2,
                                style: TextStyle(
                                    fontFamily: 'MontserratB', fontSize: 25,color: Colors.black),
                              ),
                            ),
                          ),
                          Align(
                            ...
                            child: Container(
                              ...
                              child: AutoSizeText(                                                                
                                ...
                                style: TextStyle(                                                                                                      
                                    fontFamily: 'MontserratM', fontSize: 16,color: Colors.black54),
                              ),
                            ),
                          ),
                        ],
