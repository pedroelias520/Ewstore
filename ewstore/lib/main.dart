...
void main() {
  ...
  try{    
    ...
    Map<String, dynamic> wrongNamesMap = { };
    print(wrongNames.length);
    for (int i=0;i<wrongNames.length;i++){
      wrongNamesMap['wrongName ${i}'] = wrongNames[i];
      Firestore.instance.collection('Commons').document('wrongName').setData(wrongNamesMap);
    }    
  }catch(e){
    debugPrint("===========================");
